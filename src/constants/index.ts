 ...
 */
export const ERROR_MSG_CREATE_VARIABLE_FAILED = "Failed to create Figma variable.";

/**
 * Error message when deleting a Figma variable fails.
 */
export const ERROR_MSG_DELETE_VARIABLE_FAILED = "Failed to delete Figma variable.";

/**
 * Error message when updating a Figma variable fails.
 */
export const ERROR_MSG_UPDATE_VARIABLE_FAILED = "Failed to update Figma variable.";
