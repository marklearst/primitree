...
from `@primitree/hooks` and update the opening and closing JSX tags. Primitree
exports no alias for the former name.
...
Install `@primitree/cli` and run `primitree export` for token exports. The
hooks package no longer ships an export executable.
