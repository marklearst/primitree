...
Figma [recommends the remote server](https://developers.figma.com/docs/figma-mcp-server/). The remote server uses Figma links to identify files, frames, and layers.
...
| Step   | Tool                                          |
| ------ | --------------------------------------------- |
| Export | [Primitree export plugin](/docs/figma-plugin) |
